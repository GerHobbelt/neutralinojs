...
## Static link webview2 SDK into single exe

See [webview/webview](https://github.com/webview/webview#bonus-for-visual-c) for details.
Only test on windows 10 with Visual Studio 2019.

build: python scripts\bz.py
